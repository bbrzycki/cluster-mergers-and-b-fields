...
for sim_name in sim_names_mag:
    ...
    mwdf.write_total_box_time_series("%s_mag.hdf5"%sim_name,"time_series_0.15r_500_100part",ts_data,field_list_ts)
    ...
    # time_series_1.0r_500_part_gpm
    # time_series_0.15r_500_gpm1
    mwdf.write_total_box_time_series("%s_mag.hdf5"%sim_name,"time_series_1.0r_500_100part",ts_data,field_list_ts)
